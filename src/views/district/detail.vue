<template>
  <div class="app-container">
    ...
    >
      ...
      <!-- <el-table-column label="创建时间" min-width="170px" align="center">
        <template slot-scope="{row}">
...
export default {
  ...
  created() {
    this.listQuery.search.p_id = this.$route.query.id
    console.log('route:' + this.$route.query.id)
    console.log('list1:' + this.listQuery.search.p_id)
    this.getList()
  },
  methods: {
    getList() {
      this.listLoading = true
      console.log('list2:' + this.listQuery.search.p_id)
    ...
    resetTemp() {
      this.temp = {
        name: '',
        p_id: this.listQuery.search.p_id
      }
    },
    // 添加按钮弹框
    handleCreate() {
